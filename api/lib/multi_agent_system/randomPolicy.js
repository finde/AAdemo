module.exports = function (opt) {
  ...
  _.each(opt.initPredator, function (predator) {
    world.spawnAgent('predator', predator);
  });
  ...
  _.each(opt.initPrey, function (prey) {
    world.spawnAgent('prey', prey);
  });

  this.getAllAgents = world.getAllAgents;
